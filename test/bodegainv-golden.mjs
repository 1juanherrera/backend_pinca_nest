...
const paths=[
 ['default','/api/bodegas/inventario/18'],
 ['page2 perPage5','/api/bodegas/inventario/18?page=2&perPage=5'],
 ['search','/api/bodegas/inventario/18?search=a&perPage=8'],
 ['tipo=1','/api/bodegas/inventario/18?tipo=1'],
 ['tipo=pendientes','/api/bodegas/inventario/18?tipo=pendientes'],
 ['bodega 19','/api/bodegas/inventario/19?perPage=50'],
 ['404','/api/bodegas/inventario/999999'],
];
